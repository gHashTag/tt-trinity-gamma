...
// test/tb_gf6_mul.v
// Testbench for GoldenFloat6 multiplier.
// Format: [S(1) | E(2) | M(3)], bias=1, EXP_MAX=3.
...
module tb_gf6_mul;
    ...
    gf6_mul dut (.a(a), .b(b), .result(result));
    ...
    initial begin
        ...
        $display("=== tb_gf6_mul: GoldenFloat6 [E=2|M=3] bias=1 ===");

        // --- T1: 1.0 * 1.0 = 1.0 identity ---
        tname = "1.0 * 1.0 = 1.0";
        a = 6'h8; b = 6'h8; expected = 6'h8;
        check_exact;

        // --- T2: zero * phi = 0 (zero annihilation) ---
        tname = "0 * phi = 0";
        a = 6'h0; b = 6'hD; expected = 6'h0;
        check_exact;

        // --- T3: phi * 0 = 0 ---
        tname = "phi * 0 = 0";
        a = 6'hD; b = 6'h0; expected = 6'h0;
        check_exact;

        // --- T4: NaN * 1.0 = NaN ---
        tname = "NaN * 1.0 = NaN";
        a = 6'h39; b = 6'h8; expected = 6'h39;
        check_exact;

        // --- T5: +Inf * 1.0 = +Inf ---
        tname = "+Inf * 1.0 = +Inf";
        a = 6'h18; b = 6'h8; expected = 6'h18;
        check_exact;

        // --- T6: +Inf * 0 = NaN ---
        tname = "+Inf * 0 = NaN";
        a = 6'h18; b = 6'h0; expected = 6'h39;
        check_exact;
        ...
        a = 6'h8; b = 6'hD; expected = 6'hD;
        check_exact;

        tname = "phi * phi = phi^2";
        a = 6'hD; b = 6'hD;
        // phi^2 = phi+1 ~ 2.618034; exp=bias+1, mant=2
        expected = 6'h12;
        ...
        if (fail_count == 0)
            $display("tb_gf6_mul: ALL PASS");
        else
            $display("tb_gf6_mul: FAILURES DETECTED");
        $finish;
    end
